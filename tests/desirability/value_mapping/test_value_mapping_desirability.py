...
def test_value_mapping_parameters_defaults(desirability):
...
def test_value_mapping_parameters_after_setting(desirability):
    desirability.set_coefficient_parameters_values(
        {"mapping": {"Low": 0.2, "Medium": 0.5, "High": 0.8}, "shift": 0.1}
    )
    assert desirability.get_coefficient_parameters_values() == {
        "mapping": {"Low": 0.2, "Medium": 0.5, "High": 0.8},
        "shift": 0.1,
...
def test_value_mapping_fails_without_parameters(desirability):
